...
**0.6.2.** Wired to BG3 apworld v0.4.5+. Tracks all items, all 937 locations across 18 regions, with reachability colored by Level Fragment count and visibility filtered by the slot's goal + sanity options. The items grid includes a 17-toggle goal-progress row covering the Halsin rescue plus all 16 User Defined Fights.
